...
public class SendMail {
    ...
    public void sendMail(String from, String to, String subject, String message) {
        ...
        auth = new SimpleAuth("comunicadonikken@gmail.com", "@escolanikken2020");

        //Session - objeto que ira realizar a conexo com o servidor
        /*Como h necessidade de autenticao  criada uma autenticacao que
		 *  responsavel por solicitar e retornar o usurio e senha para 
		 * autenticao */
        Session session = Session.getDefaultInstance(props, auth);
        session.setDebug(true); //Habilita o LOG das aes executadas durante o envio do email
        ...
        try {
            ...
            //Setando o contedo/corpo do email
        ...
        try {
             ...
             */
            tr.connect(mailSMTPServer, "comunicadonikken@gmail.com", "@escolanikken2020");
