...
this.btnList = {
    ...
    "bold":           ['Bold',                 'Negrito',            'editor_action(this.id)',  'ed_format_bold.gif'],
    "italic":         ['Italic',               'Italico',            'editor_action(this.id)',  'ed_format_italic.gif'],
    "underline":      ['Underline',            'Sublinhado',         'editor_action(this.id)',  'ed_format_underline.gif'],
    "strikethrough":  ['StrikeThrough',        'Tachado',            'editor_action(this.id)',  'ed_format_strike.gif'],
    "subscript":      ['SubScript',            'Subescrito',         'editor_action(this.id)',  'ed_format_sub.gif'],
    "superscript":    ['SuperScript',          'Sobrescrito',        'editor_action(this.id)',  'ed_format_sup.gif'],
    "justifyleft":    ['JustifyLeft',          'Alinhar à Esquerdo', 'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        'Centralizar',        'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         'Alinhar à Direita',  'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    'Lista Ordenada',     'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  'Lista Marcada',      'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              'Diminuir Recuo',     'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               'Aumentar Recuo',     'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            'Cor da Fonte',       'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            'Cor de Fundo',       'editor_action(this.id)',  'ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', 'Linha Horizontal',   'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           'Inserir Hiperlink',  '',  'ed_link.gif'],                             //editor_action(this.id)
    "insertimage":    ['InsertImage',          'Inserir Imagem',     '',  'ed_image.gif'],                            //editor_action(this.id)
    "inserttable":    ['InsertTable',          'Inserir Tabela',     'editor_action(this.id)',  'insert_table.gif'],
    "htmlmode":       ['HtmlMode',             'Visualizar HTML',    'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          'Aumentar Editor',    'editor_action(this.id)',  'fullscreen_maximize.gif'],
    "about":          ['about',                'Sobre o Editor',  'editor_about(\''+objname+'\')',  'ed_about.gif'],
