<%-- 
    Document   : pessoa_fisica_atualizar
    Created on : 07/08/2020, 23:32:30
    Author     : macuser
--%>
            ...
            <table border="0" align="center" style="margin-top: 20px; background-color: #8B1A1A" width="100%">
                <tr>
                    <td width="10%" style="padding-left: 50px">
                        &nbsp;
                        <a href="tela_interativa.jsp" class="btn btn-default">Voltar</a>
                    </td>
            ...
            <div class="form-group">
                <table border="0" align="center" style="margin-top: 20px;" width="80%" class="table-condensed">
                    ...
                    <tr>
                        ...
                        <td width="25%">
                            <div class="col-lg-12">
                                <label for="usr">Perfil:</label>
                                <html:hidden name="PessoaFisicaForm" property="perfil"/>
                                <html:select name="PessoaFisicaForm" property="perfil" styleId="perfil" styleClass="form-control" disabled="true">
                        ...
                        <td width="25%">
                            <div class="col-lg-12">
                                ...
                                <bean:write name="PessoaFisicaForm" property="idPF"/>
...
<script language="javascript">
    function fAtualizar() {
        ...
        if (nome.length < 2) {
            ...
            document.PessoaFisicaForm.action = "PessoaFisica.do?action=atualizar";
